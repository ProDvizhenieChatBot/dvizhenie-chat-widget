...
export interface FormField {
  field_id: string;
  type: 'info' | 'text' | 'textarea' | 'date' | 'phone' | 'email' | 'single_choice_buttons' | 'multiple_choice_checkbox' | 'file';
  label: string;
  required?: boolean;
  options?: string[];
  condition?: {
...
class ApiService {
   ...
   */
  async linkFileToApplication(applicationUuid: string, fileId: string, fieldId: string): Promise<void> {
